...
style="margin:' . (isset($FB_Shortcode['slider_margin']) && $FB_Shortcode['slider_margin'] !== '' ? $FB_Shortcode['slider_margin'] : 'auto') . ';' . (isset($fts_cycleType) && $fts_cycleType == 'carousel' ? 'width:100%; max-width:100%; overflow:hidden;height:' . $FB_Shortcode['image_height'] . ';' : 'overflow:hidden; height:' . $FB_Shortcode['image_height'] . '; max-width:' . (isset($FB_Shortcode['image_width']) && $FB_Shortcode['image_width'] !== '' ? $FB_Shortcode['image_width'] : 'auto')) . ';"
                   
                    data-cycle-caption="#fts-custom-caption-' . $fts_dynamic_class_name . '" 
                    data-cycle-caption-template="{{slideNum}} / {{slideCount}}" 
                    data-cycle-pager=".fts-custom-pager-' . $fts_dynamic_class_name . '"
                    data-cycle-pause-on-hover="true"
                    data-cycle-prev=".fts-prevControl-' . $fts_dynamic_class_name . '" 
                    data-cycle-next=".fts-nextControl-' . $fts_dynamic_class_name . '" 
                    data-cycle-timeout="' . (!empty($FB_Shortcode['slider_timeout']) ? $FB_Shortcode['slider_timeout'] : '0') . '" 
                    data-cycle-manual-speed="' . (!empty($FB_Shortcode['slider_speed']) ? $FB_Shortcode['slider_speed'] : '400') . '"
                    data-cycle-auto-height="false"
                    data-cycle-slides="> div"
                    data-cycle-fx="' . (!empty($FB_Shortcode['scrollhorz_or_carousel']) ? $FB_Shortcode['scrollhorz_or_carousel'] : '') . '"
                    data-cycle-carousel-visible=' . (!empty($FB_Shortcode['slides_visible']) ? $FB_Shortcode['slides_visible'] : '4') . '
                    data-cycle-swipe=true
                    data-cycle-swipe-fx=' . (!empty($FB_Shortcode['scrollhorz_or_carousel']) ? $FB_Shortcode['scrollhorz_or_carousel'] : '') . '
                    >';
                }
